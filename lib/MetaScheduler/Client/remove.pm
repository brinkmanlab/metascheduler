=head1 NAME
    ...
    MetaScheduler::Client::remove

=head1 DESCRIPTION

    Object for handling remove a COMPLETE requests to the scheduler
    Should be called from the client script and gets it's
    configuration from the @ARGV parameters

=head1 SYNOPSIS

    use MetaScheduler::Client::remove;
    MetaScheduler::Client::delete->initialize($host, $port, @ARGV);
...
package MetaScheduler::Client::remove;
