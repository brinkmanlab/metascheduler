=head1 NAME
    ...
    MetaScheduler::Client::timeout

=head1 DESCRIPTION

    Object for handling changing the cache timeout to the scheduler
    Should be called from the client script and gets it's
    configuration from the @ARGV parameters

=head1 SYNOPSIS

    use MetaScheduler::Client::timeout;
    MetaScheduler::Client::timeout->initialize($host, $port, @ARGV);
...
package MetaScheduler::Client::timeout;
